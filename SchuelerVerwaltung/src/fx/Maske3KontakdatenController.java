...
public class Maske3KontakdatenController {
	...
	Kontaktdaten lKontaktdaten1 = new Kontaktdaten (tfWohnort1.getText(), tfPlz1.getText(), tfFestnetzHandynummer1.getText(), tfFax1.getText(), tfEmail1.getText(), tfAdresseStraßeMitHausnummer1.getText(), tfWohnort2.getText(), tfPlz2.getText(), tfFestnetzHandynummer2.getText(), tfFax2.getText(), tfEmail2.getText(), tfAdresseStraßeMitHausnummer2.getText(), tfWohnort3.getText(), tfPlz3.getText(), tfFestnetzHandynummer3.getText(), tfFax3.getText(), tfEmail3.getText(), tfAdresseStraßeMitHausnummer3.getText());
